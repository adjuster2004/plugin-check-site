# Plugin check site and ssl certificate - плагин для проверки срока действия сертификатов сайтов и продления сайтов

Кому подойдет? - ответственным за актуальность сайтов

Доступ к странице по http://0.0.0.0:9090/ - порт можно сменить в python скрипте и настройках docker

Если посадить docker в VDS, то в плагине указывается его реальный IP
